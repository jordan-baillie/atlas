#!/usr/bin/env python3
"""Atlas Strategy Universe — submodule of research.discovery package.

Formerly research/discovery.py (standalone). Moved into the package to
resolve the package/module collision (B4 fix).
...
# One extra .parent vs. the old standalone: discovery.py → discovery/ → research/ → atlas/
