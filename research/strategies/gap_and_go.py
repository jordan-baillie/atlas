...
========================================
Buy stocks that gap UP > 2% at open with volume confirmation. Ride momentum. Exit: intraday trailing stop or close.
...
class GapAndGo(BaseStrategy):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._logger.info(f"GapAndGo initialized")
    ...
    def generate_signals(
        ...
        """Generate gap_and_go entry signals."""
        signals: List[Signal] = []
