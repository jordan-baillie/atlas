...
========================================
Extreme volume spike (>3x avg) on a down day in uptrend = capitulation selling. Buy reversal. Exit: time or strength.

Reference: Quantified Strategies volume research, Wyckoff method
Generated: 2026-03-10T07:18:31.213545+00:00
...
class VolumeClimax(BaseStrategy):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._logger.info(f"VolumeClimax initialized")
    ...
    def generate_signals(
        ...
        """Generate volume_climax entry signals."""
        signals: List[Signal] = []
