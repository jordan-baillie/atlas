...
========================================
Price makes new low but MACD histogram makes higher low. Enter long. Exit on MACD crossover or time stop.

Reference: Gerald Appel (1979), MACD divergence patterns
Generated: 2026-03-10T07:18:31.211962+00:00
...
class MacdDivergence(BaseStrategy):
    """Price makes new low but MACD histogram makes higher low"""
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._logger.info(f"MacdDivergence initialized")
    ...
    def generate_signals(
        ...
        """Generate macd_divergence entry signals."""
        signals: List[Signal] = []
