...
========================================
Buy at close, sell at open. Captures overnight premium. Filter: strong recent performers only.

Reference: Cliff et al. 'Overnight Return' (2019), Quantpedia #53
Generated: 2026-03-10T07:18:31.205401+00:00
...
class OvernightReturn(BaseStrategy):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._logger.info(f"OvernightReturn initialized")
    ...
    def generate_signals(
        ...
        """Generate overnight_return entry signals."""
        signals: List[Signal] = []
