...
========================================
Post-Earnings Announcement Drift. Buy after positive earnings surprise, hold 20-60 days. Needs earnings data.

Reference: Ball & Brown (1968), Bernard & Thomas (1989)
Generated: 2026-03-10T07:18:31.207486+00:00
...
class PeadEarningsDrift(BaseStrategy):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._logger.info(f"PeadEarningsDrift initialized")
    ...
    def generate_signals(
        ...
        """Generate pead_earnings_drift entry signals."""
        signals: List[Signal] = []
