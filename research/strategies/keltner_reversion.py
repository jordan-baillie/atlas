...
========================================
Price touches lower Keltner Channel (EMA ± ATR mult) → buy. Exit at middle band (EMA). Uptrend filter.

Reference: Chester Keltner (1960), modernized by Linda Bradford Raschke
Generated: 2026-03-10T07:18:31.208938+00:00
...
class KeltnerReversion(BaseStrategy):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._logger.info(f"KeltnerReversion initialized")
    ...
    def generate_signals(
        ...
        """Generate keltner_reversion entry signals."""
        signals: List[Signal] = []
