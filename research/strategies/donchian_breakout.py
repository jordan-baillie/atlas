...
========================================
Buy on 20-day high breakout, sell on 10-day low. Classic trend following. ATR position sizing.

Reference: Richard Donchian, Turtle Traders (1983)
Generated: 2026-03-10T07:18:31.199059+00:00
...
class DonchianBreakout(BaseStrategy):
    """Buy on 20-day high breakout, sell on 10-day low"""
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._logger.info(f"DonchianBreakout initialized")
    ...
    def generate_signals(
        ...
        """Generate donchian_breakout entry signals."""
        signals: List[Signal] = []
