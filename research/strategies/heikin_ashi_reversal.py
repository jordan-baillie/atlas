...
========================================
3+ red Heikin-Ashi candles followed by green doji/reversal in uptrend. Enter long. Exit on 2 red HA candles.
...
class HeikinAshiReversal(BaseStrategy):
    """3+ red Heikin-Ashi candles followed by green doji/reversal in uptrend"""
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._logger.info(f"HeikinAshiReversal initialized")
    ...
    def generate_signals(
        ...
        """Generate heikin_ashi_reversal entry signals."""
        signals: List[Signal] = []
