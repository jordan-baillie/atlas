...
# ── /api/regime/history + /api/regime/current — moved to services/api/regime.py ─
...
# ── /api/regime/forecast — moved to services/api/regime.py ─────────────────
...
# ── /api/regime/distributions — moved to services/api/regime.py ────────────
