...
Glob patterns scanned:
  brokers/state/*.pre-*    (incident snapshots — operator quarantine)
  brokers/state/*.bak*     (ad-hoc state backups)
...
PATTERNS: list[tuple[str, str]] = [
    ("brokers_state_pre", "brokers/state/*.pre-*"),
    ("brokers_state_bak", "brokers/state/*.bak*"),
