...
// GroupDivider — left-aligned Forge-style section label between dashboard groups
  ...
  return (
    <details open={defaultOpen} className="group">
      <summary className="flex items-center gap-2 py-2 cursor-pointer list-none select-none px-0.5">
        ...
        <svg
          className="w-3.5 h-3.5 text-[var(--color-text-muted)] transition-transform duration-200 group-open:rotate-90"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
