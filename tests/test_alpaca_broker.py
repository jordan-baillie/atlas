...
from brokers.alpaca.broker import (
...
class TestConnect:
    @patch("brokers.alpaca.broker.get_secret")
    @patch("brokers.alpaca.broker.TradingClient")
    @patch("brokers.alpaca.broker.AlpacaMarketData")
    ...
    @patch("brokers.alpaca.broker.get_secret", return_value=None)
