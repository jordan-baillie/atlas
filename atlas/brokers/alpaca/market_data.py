...
class AlpacaMarketData:
    ...
    def get_latest_quotes(self, tickers: list[str]) -> dict[str, dict]:
        ...
        from atlas.brokers.alpaca.mapper import to_alpaca_list, to_atlas
    ...
    def download_universe_bars(
        ...
        if crypto_tickers:
            ...
            from atlas.brokers.alpaca.mapper import to_alpaca, to_atlas
...
def get_historical_bars(
    ...
    try:
        from alpaca.data.timeframe import TimeFrame
        from alpaca.data.enums import Adjustment
        from atlas.brokers.alpaca.mapper import to_alpaca, to_alpaca_list, to_atlas
    ...
    result = {}
    try:
        from atlas.brokers.alpaca.mapper import to_atlas
