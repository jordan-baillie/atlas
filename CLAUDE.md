...
This project is indexed by GitNexus as **atlas** (8537 symbols, 22578 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
